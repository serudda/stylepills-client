...
const HomePage: React.SFC<HomePageProps> = () => {
    ...
    const _handleWaypointEnter = (section: string) => (e: any) => {
        
        // CONSTANTS
        const PUV_IMAGE_URL = '../../../resources/images/add_component_page.png';
        const HOST_COMPONENT_IMAGE_URL = '../../../resources/images/add_component_page.png';
        const PRIVATE_COMPONENT_IMAGE_URL = '../../../resources/images/add_component_page.png';
        const ATTACH_IMAGE_URL = '../../../resources/images/add_component_page.png';
        const FEED_REPOSITORY_IMAGE_URL = '../../../resources/images/add_component_page.png';
        const CREATE_STYLEGUIDE_IMAGE_URL = '../../../resources/images/add_component_page.png';

        switch (section) {
            case '1':
                return PUV_IMAGE_URL;
            case '2':
                return HOST_COMPONENT_IMAGE_URL;
            case '3':
                return PRIVATE_COMPONENT_IMAGE_URL;
            case '4':
                return FEED_REPOSITORY_IMAGE_URL;
            case '5':
                return ATTACH_IMAGE_URL;
            case '6':
                return CREATE_STYLEGUIDE_IMAGE_URL;
            default:
                return PUV_IMAGE_URL;
        }
    };
        ...
        <div className="HomePage row no-gutters">
            ...
            <div className="leftSide col-12 col-lg-5 px-lg-5">
                ...
                <div className="leftSide__content">
                    ...
                    <Waypoint
                        onEnter={_handleWaypointEnter('1')}
                    /> 
                    ...
                    <Waypoint
                        onEnter={_handleWaypointEnter('2')}
                    /> 
                    ...
                    <Waypoint
                        onEnter={_handleWaypointEnter('3')}
                    /> 
                    ...
                    <Waypoint
                        onEnter={_handleWaypointEnter('4')}
                    /> 
                    ...
                    <Waypoint
                        onEnter={_handleWaypointEnter('5')}
                    /> 
                    ...
                    <Waypoint
                        onEnter={_handleWaypointEnter('6')}
                    /> 
