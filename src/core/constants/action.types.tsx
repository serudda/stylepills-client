...
export const LOAD_SOURCE_CODE_TABS = 'TABS::LOAD_SOURCE_CODE_TABS';
export type LOAD_SOURCE_CODE_TABS = typeof LOAD_SOURCE_CODE_TABS;
...
export const CLEAR_SOURCE_CODE = 'SOURCE_CODE_PANEL::CLEAR_SOURCE_CODE';
export type CLEAR_SOURCE_CODE = typeof CLEAR_SOURCE_CODE;
...
export const GET_PREPROCESSORS_REQUEST = 'GET_PREPROCESSORS_REQUEST';
export type GET_PREPROCESSORS_REQUEST = typeof GET_PREPROCESSORS_REQUEST;
export const GET_PREPROCESSORS_SUCCESS = 'GET_PREPROCESSORS_SUCCESS';
export type GET_PREPROCESSORS_SUCCESS = typeof GET_PREPROCESSORS_SUCCESS;
export const GET_PREPROCESSORS_FAILURE = 'GET_PREPROCESSORS_FAILURE';
export type GET_PREPROCESSORS_FAILURE = typeof GET_PREPROCESSORS_FAILURE;

export const LOAD_PREPROCESSORS = 'LOAD_PREPROCESSORS';
export type LOAD_PREPROCESSORS = typeof LOAD_PREPROCESSORS;
