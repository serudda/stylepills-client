...
export const ADD_SOURCE_ITEM = 'LISTS::ADD_SOURCE_ITEM';
export type ADD_SOURCE_ITEM = typeof ADD_SOURCE_ITEM;
export const EDIT_SOURCE_ITEM = 'LISTS::EDIT_SOURCE_ITEM';
export type EDIT_SOURCE_ITEM = typeof EDIT_SOURCE_ITEM;
export const DELETE_SOURCE_ITEM = 'LISTS::DELETE_SOURCE_ITEM';
export type DELETE_SOURCE_ITEM = typeof DELETE_SOURCE_ITEM;
export const CHANGE_SOURCE_ITEM_ORDER = 'LISTS::CHANGE_SOURCE_ITEM_ORDER';
export type CHANGE_SOURCE_ITEM_ORDER = typeof CHANGE_SOURCE_ITEM_ORDER;
export const LOAD_SOURCES = 'LISTS::LOAD_SOURCES';
export type LOAD_SOURCES = typeof LOAD_SOURCES;

export const ADD_COLOR_ITEM = 'LISTS::ADD_COLOR_ITEM';
export type ADD_COLOR_ITEM = typeof ADD_COLOR_ITEM;
export const EDIT_COLOR_ITEM = 'LISTS::EDIT_COLOR_ITEM';
export type EDIT_COLOR_ITEM = typeof EDIT_COLOR_ITEM;
export const DELETE_COLOR_ITEM = 'LISTS::DELETE_COLOR_ITEM';
export type DELETE_COLOR_ITEM = typeof DELETE_COLOR_ITEM;
